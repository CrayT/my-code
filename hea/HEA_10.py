...
# , '1/(((pow3RMS)*(pow2rootHmix0)))','1/(((pow3RMS)*(pow3rootHmix0)))', '1/(((logr)*(logrootHmix0-)))',
vars = [ '1/(((pow1/2RMS)*(logrootHmix0)))', '1/(((pow1/2VEC)*(pow3VEC)))', '1/(((logFi)*(pow3VEC)))', '1/(((pow2RMS)*(logVEC)))', '1/(((pow2VEC)*(pow1/2rootHmix0-)))','1/(((pow3RMS)*(pow2rootHmix0)))','1/(((pow3RMS)*(pow3rootHmix0)))', '1/(((logr)*(logrootHmix0-)))']
for key in vars:
...
x_tmp.to_csv("corelation_tmp.csv")
print(x_tmp.shape)
x_tmp = x_tmp[vars]
print(x_tmp.shape)
