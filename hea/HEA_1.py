...
#所有共有属性集合:
x_parameter_collection=['Fi','r']

names=['alloy','class','p','Hmix','Smix','Tm','Ou','delta','x','VEC','Fi','RMS','H','kcr','elta','E','Sc','r','deltaHmixmax','deltaHmixmin','rootHmix','rootHmix0','rootHmix0+','rootHmix0-']
data=pd.read_csv('/Users/xutao/Nustore Files/我的坚果云/HEA/Gao dataset_all.csv',header=0,names=names) #/Users/xutao/Nustore Files/我的坚果云/HEA #/Users/xutao/Downloads/Python/HEA/

Y=data[["class"]]
X=data[x_parameter_collection]


name_test=['alloy','class','delta','Hmix','Smix','Fi','RMS1','RMS','VEC','r','Sc','deltaHmixmax','deltaHmixmin','rootHmix','rootHmix0','rootHmix0+','rootHmix0-']
data_test=pd.read_csv('/Users/xutao/Nustore Files/我的坚果云/HEA/Ye dataset_all.csv',header=0,names=name_test)
Y_test=data_test[['class']]
Y_test_alloy=data_test[['alloy']]

X_test=data_test[x_parameter_collection]
...
#x_train['deltaHmixmin']=mas.transform(x_train['deltaHmixmin'])
#x_train['r']=mas.transform(x_train['r'])
...
print "1:","KNC:",knc.score(x_test,y_test),'DTC:',dtc.score(x_test,y_test),"RFC:",rfc.score(x_test,y_test),"GBC:",gbc.score(x_test,y_test),"Ada:",abc.score(x_test,y_test),"SVC:",svc.score(x_test,y_test)

print "2:","KNC:",knc.score(X_test,Y_test),"DTC:",dtc.score(X_test,Y_test),"RFC:",rfc.score(X_test,Y_test),"GBC:",gbc.score(X_test,Y_test),"Ada:",abc.score(X_test,Y_test),"SVC:",svc.score(X_test,Y_test)
...
rfe = RFE(gbc,n_features_to_select=3) # limit number of variables to three
rfe = rfe.fit(X_test,Y_test)
#print(rfe.support_) 
print("GBC:",rfe.ranking_) #Selected (i.e., estimated best) features are assigned rank 1.
...
plot_decision_regions(X=X_combined_std, y=y_combined,  
                      classifier=gbc, test_idx=range(105, 150))  
