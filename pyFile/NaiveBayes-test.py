...
def spamTest():
    ...
    for i in range(1,26):
        #读取垃圾邮件
        wordList = textParse(open('/Users/xutao/Downloads/MLaction-master/Ch04_NaiveBayes/email/spam/%d.txt' % i,'r',encoding= 'utf-8').read())
        docList.append(wordList)
        fullText.extend(wordList)
        #设置垃圾邮件类标签为1
        classList.append(1)        
        wordList = textParse(open('/Users/xutao/Downloads/MLaction-master/Ch04_NaiveBayes/email/ham/%d.txt' % i,'r',encoding= 'utf-8').read())
        docList.append(wordList)
        fullText.extend(wordList)
        classList.append(0)
